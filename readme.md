...
| ALU Operation Code|   Operation performed	| Operation Description|
| ------------------|:----------|:----------------------------------|	
|ALU_operation|	4'b0000	|A AND B	|
|ALU_operation|	4'b0001	|A OR B	|
|ALU_operation|	4'b0010	|A ADD B	|
|ALU_operation|	4'b0110	|A SUBTRACT B|
|ALU_operation|	4'b0111	|B|
|ALU_operation|	4'b1100	|NOR|
|ALU_operation|	4'b1111	|default or edge cases|
